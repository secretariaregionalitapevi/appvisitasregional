-- O status operacional representa frequência recente no SAM, não o cadastro.
-- "A excluir" é uma indicação adicional e permanece dentro de INATIVO.
...
'Status operacional por última atividade SAM: ATIVO até 90 dias, ALERTA de 91 a 180, INATIVO acima de 180. requires_review marca o subconjunto acima de 365 dias.';
