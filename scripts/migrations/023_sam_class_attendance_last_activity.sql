-- Inclui presenças em aulas do GEM no último lançamento operacional do aluno.
-- Ausências permanecem disponíveis no boletim, mas não contam como atividade.
...
select
    ...
    case when activity.last_activity_at is not null
               and current_date - activity.last_activity_at::date > 365
         then true else false end as requires_review
...
'Status operacional pela última atividade individual ou presença confirmada em aula do GEM sincronizada do SAM.';
